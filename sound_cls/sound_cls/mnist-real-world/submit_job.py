...
def main():
    ...
    parser.add_argument("--job", type=str, default="mnist_fedavg", help="Path to job")
    ...
    parser.add_argument(
        "--train_split_root", type=str, default="/tmp/mnist_splits", help="Location where to save data splits."
    )
    parser.add_argument(
        "--alpha",
        type=float,
